    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("REGIONAL", "Региональное"), ("LOCAL", "Локальное")],
                        max_length=40,
                ...
                (
                    "start_at",
                    models.DateTimeField(
                        validators=[event.validators.data_time_validator],
                        verbose_name="Начало",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        blank=True, upload_to="reviews/", verbose_name="Файл"
                    ),
                ),
                (
                    "pub_date",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("author", "event"), name="unique_review"
            ),
        ),
        migrations.AddConstraint(
